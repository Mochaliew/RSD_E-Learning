...
{
    [DbContext(typeof(DB))]
    [Migration("20251218064415_AddCourseRejectionFields")]
    partial class AddCourseRejectionFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSD_E_Learning.Models.DB+User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "FVAGXVcS0AirO77oQQhYCccw9UMGHI6sTDKtLUGv7sU=",
                            Role = 0
                        });
                });
            ...
            modelBuilder.Entity("RSD_E_Learning.Models.DB+Enrollment", b =>
                {
                    b.HasOne("RSD_E_Learning.Models.DB+Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
